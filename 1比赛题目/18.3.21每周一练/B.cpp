...
//    printf("[%d,%d] [%d,%d]\n",tree[pos<<1].l,tree[pos<<1].r,lsh[tree[pos<<1].l],lsh[tree[pos<<1].r]);
//    printf("[%d,%d] [%d,%d]\n",tree[pos<<1|1].l,tree[pos<<1|1].r,lsh[tree[pos<<1|1].l],lsh[tree[pos<<1|1].r]);
//	printf("%d %d\n",tree[pos<<1].real_len(),tree[pos<<1|1].real_len()); 
}
